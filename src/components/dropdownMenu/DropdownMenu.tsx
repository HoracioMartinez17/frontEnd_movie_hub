...
export const DropdownMenu = ({ isDropdownVisible }: { isDropdownVisible: boolean }) => {

    const { logout } = useAuth0()
    return (
        <div className={`${css.input} ${isDropdownVisible ? css.visible : ''}`}>
            <button type='button' className={css.value}>
            ...
            <button type='button' className={css.value} onClick={(): Promise<void> => logout()} >
